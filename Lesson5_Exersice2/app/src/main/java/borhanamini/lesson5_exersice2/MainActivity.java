...
public class MainActivity extends ListActivity {
    ...
    public void updateAdapterData() {
        ...
        Cursor c = db.query(DBHelper.TABLE_SHOPPING,
    ...
    public void onDeleteClicked(View view) {
        ...
        if (position >= 0) {
            ...
            int rowsAffected = db.delete(DBHelper.TABLE_SHOPPING, DBHelper.C_ID + " = " + itemId, null);
            db.close();
            if (rowsAffected > 0)
                updateAdapterData();
        }
    ...
    public void addPerson(String name) {
        ...
        db.insert(DBHelper.TABLE_SHOPPING, null, cv);
        db.close();
